...
$sql="select ID, Dish, Ingredients, Cooking_time, Price, Image from menu;";
$result = $mysqli->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["ID"]. "</td><td>" . $row["Dish"]. "</td><td> " . $row["Ingredients"]. "</td><td>" . $row["Cooking_time"]. "</td><td>" . $row["Price"]. "</td><td><img src='images/".$row["Image"]."' style: width=150, height=150;></td></tr>";
    }
    echo "</table>";}
    else {
  echo "0 results";
